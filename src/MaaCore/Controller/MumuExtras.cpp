...
bool MumuExtras::init(const std::filesystem::path& mumu_path, int mumu_inst_index, int mumu_display_id)
{
    bool same = mumu_path == mumu_path_ && mumu_inst_index == mumu_inst_index_ && mumu_display_id == mumu_display_id_;
